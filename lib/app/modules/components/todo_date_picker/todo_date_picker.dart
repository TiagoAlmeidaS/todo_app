...
import 'package:todo_app/app/modules/components/todo_date_picker/todo_date_widget.dart';
...
class TodoDatePicker extends StatefulWidget {
  ...
  /// TodoDatePicker Controller
  final TodoDatePickerController? controller;
...
class _TodoDatePickerState extends State<TodoDatePicker> {
  ...
  void initState() {
    ...
    if (widget.controller != null) {
      widget.controller!.setTodoDatePickerState(this);
    }
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          DateTime date;
          DateTime dateVar = widget.startDate.add(Duration(days: index));
          date = DateTime(dateVar.year, dateVar.month, dateVar.day);
...
class TodoDatePickerController {
  _TodoDatePickerState? _datePickerState;

  // ignore: library_private_types_in_public_api
  void setTodoDatePickerState(_TodoDatePickerState state) {
