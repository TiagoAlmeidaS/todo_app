      ...
      body: SafeArea(
        child: Column(
          children: [
            TodoTitlePage(
              firstLabel: "Welcome, ",
              secondLabel: controller.customerName,
            ),
            const SizedBox(
              height: 36,
            ),
            ...
            Text(
              "e-mail:",
              style: Modular.get<ITodoTheme>().hintTextMenuProfile,
            ),
            const SizedBox(
              height: 2,
            ),
            Text(
              ...
              style: Modular.get<ITodoTheme>().labelTextMenuProfile,
            ),
            const SizedBox(
              height: 60,
            ),
            TodoButtonMenuProfile(
              nameButton: "Who i am?",
              iconData: LineAwesomeIcons.identification_card,
              onTap: () {},
            ),
            const Padding(
